"""
Django settings for NSL-KDD Dataset API project.
...
# Database
# Using SQLite for simplicity (Render provides PostgreSQL if needed)
DATABASES = {
    'default': {
...
# If DATABASE_URL is set (for PostgreSQL on Render), use it
